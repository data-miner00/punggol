...
Clone this repository locally. Recurse into the submodules when cloning the repository.

```
git clone --recurse-submodules https://github.com/data-miner00/punggol.git
```
...
raylib is required to build this project. Change directory into `lib/raylib/src`.
